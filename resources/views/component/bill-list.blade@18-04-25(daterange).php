                        ...
                        <div class="table-responsive p-0">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td>To Date:</td>
                                        <td><input type="text" id="toDate" data-plugin="datepicker" placeholder="To Date" onchange="selectDate()"></td>
                                    </tr>
                                    <tr>
                                        <td>From Date:</td>
                                        <td><input type="text" id="fromDate" data-plugin="datepicker" placeholder="From Date" onchange="selectDate()"></td>
                                    </tr>
                                </tbody>
                            </table>
                                    ...
                                    <tr @if($bill_data->flag == 'original') style="background-color: #add9ff;" @elseif($bill_data->flag == 'duplicate') style="background-color: #ceffba;" @endif>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{$bill_data->invoice_id}}</h6>
                                                    <p class="text-xs text-secondary mb-0">
    ...
    $(document).ready(function () {
        ...
        $.fn.dataTable.ext.search.push(
            function (settings, data, dataIndex) {
                ...
                var date = data[4]; // index of Date column
                ...
                if ((from === null || billDate >= from) && (to === null || billDate <= to)) {
                    return true;
                }
                return false;
            }
        ...
        // Trigger redraw when date changes

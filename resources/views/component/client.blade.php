        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Add Client</li>
                </ol>
            </nav>
        </div>
    </nav>
...
<script>
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        if (!clientName) showError(document.getElementById('client_name'), "Client Name is required.");
        if (!phNo || isNaN(phNo)) showError(document.getElementById('ph_no'), "Valid Phone Number is required.");

                                ...
                                <ul class="list-group" id="workTypeList">
                                    ...
                                    <div class="li">
                                        <div class="row mb-2">
                                            ...
                                            <input type="text" id="wt2_id_0" value="{{$edit_bill_details[0]->wt2_id}}">

                                            <div class="col-sm-6" id="wt2_select_0">
                                                <div class="select_box">
                                                    <label for="wt2_0" class="client_heading">Work type 2: </label>
                                                    <select class="form-select select_list wt2_change select2" id="wt2_0" name="selectwt2[]" onchange="">
                                            ...
                                            <!-- <div class="col-sm-6 mt-1" id="wt2_details_0" style="display: none;">
                                                <div class="select_box">
                                                    ...
                                                    <input type="text" class="form-control input_div wt2_details" name="selectwt2[]" id="wt2_0">
                                                </div>
                                            </div> -->
                                        ...
                                        <div id="hsn_gst" class="hsn_gst" style="display: none;">
                                            ...
                                            <div class="row  mb-3 " id="hsn_block_other_0" style="display: none;">
                                                <div class="col-sm-6">
                                                    <label for="hsn" class="client_heading">HSN Code: </label>
                                                    <input type="text" name="hsn[]" id="hsn_other_0" class="form-control input_div" value="">
                                                </div>

                                                <div class="col-sm-6">
                                                    <label for="gst" class="client_heading">GST: </label>
                                                    <input type="number" name="other_gst[]" id="other_gst_0" class="form-control input_div" value="">
                                                </div>
                                            </div>
                                    ...
                                    @for($key=1;$key < count($edit_bill_details);$key++)
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <input type="text" id="wt2_id_{{$key}}" value="{{$edit_bill_details[$key]->wt2_id}}">
                                            ...
                                            <!-- <div class="col-sm-6 mt-1" id="wt2_details_{{$key}}" style="display: none;">
                                                <div class="select_box">
                                                    ...
                                                    <input type="text" class="form-control input_div wt2_details" name="selectwt2[]" id="wt2_{{$key}}">
                                                </div>
                                            </div> -->
                                        ...
                                        <div id="hsn_gst" class="hsn_gst" style="display: none;">
                                            ...
                                            <div class="row  mb-3 " id="hsn_block_other_{{$key}}" style="display: none;">
                                                <div class="col-sm-6">
                                                    <label for="hsn" class="client_heading">HSN Code: </label>
                                                    <input type="text" name="hsn[]" id="hsn_other_{{$key}}" class="form-control input_div" value="">
                                                </div>

                                                <div class="col-sm-6">
                                                    <label for="gst" class="client_heading">GST: </label>
                                                    <input type="number" name="other_gst[]" id="other_gst_{{$key}}" class="form-control input_div" value="">
                                                </div>
                                            </div>

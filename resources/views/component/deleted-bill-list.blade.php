        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Deleted Bill List</li>
                </ol>
            </nav>
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                            ...
                            <table class="table align-items-center mb-0" id="billTable">
                                ...
                                <tbody>
                                    @foreach($deleted_bill_list as $bill_data)
                                    <tr @if($bill_data->flag == 'original') style="background-color: #add9ff;" @elseif($bill_data->flag == 'duplicate') style="background-color: #ceffba;" @endif>
                                        ...
                                        <td class="align-middle text-center">
                                            <span class="text-secondary text-xs font-weight-bold">{{number_format(round($bill_data->total_amount))}}</span>
                                        </td>
...
<!--
                                        <td class="align-middle">
                                            <a href="javascript:;" class=" duplicate-bill-btn btn-warning btn btn-sm mb-0 me-1" data-id="{{$bill_data->bill_unique_id}}" @if($bill_data->flag == 'duplicate') style="display: none;" @endif>Duplicate Bill</a>


                                        </td> -->

                                        <td class="align-middle">
                                            <!-- <a href="{{route('print.bill', ['unique_id' => $bill_data->bill_unique_id])}}" class=" btn-success btn btn-sm mb-0 me-1" target="_blank">Print</a> -->

                                            <a href="javascript:void(0);" class=" btn-info btn btn-sm mb-0 me-2" id="view_btn" style="" onclick="handleView('{{ $bill_data->bill_unique_id }}')">View</a>
                                            ...
                                            @endphp
                                            <a href="{{route('delete.bill', ['unique_id' => $bill_data->bill_unique_id])}}" class="btn-sm duplicate-bill-btn btn-danger btn mb-0 me-3" style="{{$style}}">Delete</a> -->
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>

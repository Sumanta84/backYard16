...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg" style="margin-left: 250px;">
    ...
    <div class="container-fluid py-2">
        <div class="form_body">
            <form action="{{route('bill.update')}}" method="POST" id="asas">
                @csrf

                <input type="hidden" name="billUniqueId" id="billUniqueId" value="{{$edit_bill_details[0]->bill_unique_id}}">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                                ...
                                <div class="card card-body border  border-radius-lg d-flex align-items-left ">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="hidden" name="invoice_date" id="invoice_date" placeholder="invoice date"
                                                class="form-control input_div" value="{{$edit_bill_details[0]->invoice_date}}">

                                            <input type="date" name="invoice_date_show" id="invoice_date_show" placeholder="invoice date"
                                                class="form-control input_div" value="{{$edit_bill_details[0]->invoice_date}}" disabled>
                                        </div>
                                        ...
                                        <div class="col-md-3 mt-2" id="non_gst_bill_invoice">
                                            <label for="non_gst_bill_invoice" class="client_heading">Invoice no</label>

                                            <input type="text" name="non_gst_bill_invoice_show" id="non_gst_bill_invoice_show" placeholder="Invoice no"
                                                class="form-control input_div" value="{{$edit_bill_details[0]->invoice_no}}" disabled>

                                            <input type="hidden" name="non_gst_bill_invoice" id="
                                            " placeholder="Invoice no"
                                                class="form-control input_div" value="{{$edit_bill_details[0]->invoice_no}}">
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-header pb-0 px-3">
                                ...
                                <div class="billing_btn">
                                    ...
                                    <input type="hidden" id="edit_gst" value="{{$edit_bill_details[0]->bill_type}}">

                                    <input type="hidden" id="edit_igst" value="{{$edit_bill_details[0]->igst}}">
                            ...
                            <div class="card-body pt-4 p-3">
                                ...
                                <ul class="list-group" id="workTypeList">
                                    ...
                                    <div class="li">
                                        <div class="row mb-2">
                                            <input type="hidden" id="wt1_id_0" value="{{$edit_bill_details[0]->wt1_id}}">

                                            <div class="col-sm-6">
                                                <div class="select_box">
                                                    <label for="wt1_0" class="client_heading">Work type 1: </label>
                                                    <select class="form-select select_list wt1_change select2" id="wt1_0" name="selectwt1[]">
                                                        <option value="" selected>Select Work type 1</option>
                                                        @foreach($work_type1_data as $key1 => $value)
                                                        <option value="{{$value->id}}" {{ $edit_bill_details[0]->wt1_id == $value->id ? 'selected' : '' }}>{{$value->wt_1_item}}</option>
                                                        @endforeach
                                            ...
                                            <input type="hidden" id="wt2_id_0" value="{{$edit_bill_details[0]->wt2_id}}">

                                            <div class="col-sm-6" id="wt2_select_0">
                                                <div class="select_box">
                                                    <label for="wt2_0" class="client_heading">Work type 2: </label>
                                                    <select class="form-select select_list wt2_change select2 selectwt2_0" id="wt2_0" name="selectwt2[]" onchange="">
                                            ...
                                            <div class="col-sm-6 mt-1" id="wt2_details_0" style="display: none;">
                                                <div class="select_box">

                                                    <label for="wt2_details_0" class="client_heading">Work Type 2 Details: </label>

                                                    <input type="text" class="form-control input_div wt2_details inputwt2_0" name="selectwt2[]" id="ip_wt2_0">
                                                </div>
                                            </div>
                                        ...
                                        <div id="hsn_gst" class="hsn_gst" style="display: none;">
                                            ...
                                            <div class="row  mb-3" id="hsn_block_gst_0" style="display: none;">
                                                <div class="col-sm-6">
                                                    <label for="hsn" class="client_heading">HSN Code: </label>

                                                    <input type="text" id="hsn_show_gst_0" class="form-control input_div" value="" disabled>

                                                    <input type="hidden" name="hsn[]" id="hsn_gst_0" class="form-control input_div" value="">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="gst" class="client_heading">GST: </label>

                                                    <input type="number" id="gst_show_block_gst_0" class="form-control input_div" value="" disabled>


                                                    <input type="hidden" name="gst[]" id="gst_block_gst_0" class="form-control input_div" value="">
                                                </div>
                                            </div>


                                            <div class="row  mb-3 " id="hsn_block_other_0" style="display: none;">
                                                <div class="col-sm-6">
                                                    <label for="hsn" class="client_heading">HSN Code: </label>
                                                    <input type="text" name="hsn[]" id="hsn_other_0" class="form-control input_div" value="0">
                                                </div>

                                                <div class="col-sm-6">
                                                    <label for="gst" class="client_heading">GST: </label>
                                                    <input type="number" name="gst[]" id="other_gst_0" class="form-control input_div" value="0">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row ">
                                            <div class="col-sm-3">
                                                <label for="unit_0" class="client_heading">Unit: </label>
                                                <!-- <span id="unit_1" class="span_div"></span> -->
                                                <select name="unit[]" id="unit" class="form-select select_list">
                                                    <!-- <option value="" selected>Select Unit</option> -->
                                                    <option value="sq.ft" {{ 'sq.ft' == $edit_bill_details[0]->unit ? 'selected' : '' }}>Sq.ft</option>
                                                    <option value="number" {{ 'number' == $edit_bill_details[0]->unit ? 'selected' : '' }}>Number</option>
                                                    <option value="months" {{ 'months' == $edit_bill_details[0]->unit ? 'selected' : '' }}>Months</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <label for="rate_0" class="client_heading">Rate: </label>
                                                <input type="number" name="input_rate[]" id="input_rate_0" class="form-control input_div duplicate_rate_input" value="{{$edit_bill_details[0]->rate}}">
                                                <!-- <span id="rate_1" class="span_div duplicate_rate_span"></span> -->

                                            </div>
                                            <div class="col-sm-3">
                                                <label for="quantity_0" class="client_heading">Quantity: </label>
                                                <input type="number" class="form-control input_div item_quantity" name="qty[]" id="qty_0" value="{{$edit_bill_details[0]->quantity}}">
                                            </div>
                                            <div class="col-sm-3">
                                                <label for="total_0" class="client_heading">Total: </label>
                                                <span id="total_0" class="span_div"></span>
                                            </div>
                                        </div>

                                        <div class="row mb-3 mt-2">
                                            <div class="col-sm-6">
                                                <label for="desc_0" class="client_heading">Description: </label>
                                                <textarea name="desc[]" id="desc_0" class="form-control input_div"></textarea>
                                            </div>
                                        </div>
                                    ...
                                    @for($key=1;$key < count($edit_bill_details);$key++)

                                        <div class="li">
                                        <div class="row mb-2">
                                            <input type="hidden" id="wt1_id_{{$key}}" value="{{$edit_bill_details[$key]->wt1_id}}">

                                            <div class="col-sm-6">
                                                <div class="select_box">
                                                    <label for="wt1_{{$key}}" class="client_heading">Work type 1: </label>
                                                    <select class="form-select select_list wt1_change select2" id="wt1_{{$key}}" name="selectwt1[]">
                                                        <option value="" selected>Select Work type 1</option>
                                                        @foreach($work_type1_data as $key1 => $value)
                                                        <option value="{{$value->id}}" {{ $edit_bill_details[$key]->wt1_id == $value->id ? 'selected' : '' }}>{{$value->wt_1_item}}</option>
                                                        @endforeach
                                            ...
                                            <input type="hidden" id="wt2_id_{{$key}}" value="{{$edit_bill_details[$key]->wt2_id}}">

                                            <div class="col-sm-6" id="wt2_select_{{$key}}">
                                                <div class="select_box">
                                                    <label for="wt2_{{$key}}" class="client_heading">Work type 2: </label>
                                                    <select class="form-select select_list wt2_change select2" id="wt2_{{$key}}" name="selectwt2[]" onchange="">
                                                        <option value="" selected>Select Work type 2</option>
                                                    </select>
                                            ...
                                            <div class="col-sm-6 mt-1" id="wt2_details_{{$key}}" style="display: none;">
                                                <div class="select_box">

                                                    <label for="wt2_details_{{$key}}" class="client_heading">Work Type 2 Details: </label>

                                                    <input type="text" class="form-control input_div wt2_details inputwt2_{{$key}}" name="selectwt2[]" id="ip_wt2_{{$key}}">
                                                </div>
                                            </div>
                                        ...
                                        <div id="hsn_gst" class="hsn_gst" style="display: none;">
                                            ...
                                            <div class="row  mb-3" id="hsn_block_gst_{{$key}}" style="display: none;">
                                                <div class="col-sm-6">
                                                    <label for="hsn" class="client_heading">HSN Code: </label>

                                                    <input type="text" id="hsn_show_gst_{{$key}}" class="form-control input_div" value="" disabled>

                                                    <input type="hidden" name="hsn[]" id="hsn_gst_{{$key}}" class="form-control input_div" value="">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="gst" class="client_heading">GST: </label>

                                                    <input type="number" id="gst_show_block_gst_{{$key}}" class="form-control input_div" value="" disabled>


                                                    <input type="hidden" name="gst[]" id="gst_block_gst_{{$key}}" class="form-control input_div" value="">
                                                </div>
                                            </div>


                                            <div class="row  mb-3 " id="hsn_block_other_{{$key}}" style="display: none;">
                                                <div class="col-sm-6">
                                                    <label for="hsn" class="client_heading">HSN Code: </label>
                                                    <input type="text" name="hsn[]" id="hsn_other_{{$key}}" class="form-control input_div" value="0">
                                                </div>

                                                <div class="col-sm-6">
                                                    <label for="gst" class="client_heading">GST: </label>
                                                    <input type="number" name="gst[]" id="other_gst_{{$key}}" class="form-control input_div" value="0">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row ">
                                            <div class="col-sm-3">
                                                <label for="unit_{{$key}}" class="client_heading">Unit: </label>
                                                <!-- <span id="unit_1" class="span_div"></span> -->
                                                <select name="unit[]" id="unit" class="form-select select_list">
                                                    <!-- <option value="" selected>Select Unit</option> -->
                                                    <option value="sq.ft" {{ 'sq.ft' == $edit_bill_details[$key]->unit ? 'selected' : '' }}>Sq.ft</option>
                                                    <option value="number" {{ 'number' == $edit_bill_details[$key]->unit ? 'selected' : '' }}>Number</option>
                                                    <option value="months" {{ 'months' == $edit_bill_details[$key]->unit ? 'selected' : '' }}>Months</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <label for="rate_{{$key}}" class="client_heading">Rate: </label>
                                                <input type="number" name="input_rate[]" id="input_rate_{{$key}}" class="form-control input_div duplicate_rate_input" value="{{$edit_bill_details[$key]->rate}}">
                                                <!-- <span id="rate_1" class="span_div duplicate_rate_span"></span> -->

                                            </div>
                                            <div class="col-sm-3">
                                                <label for="quantity_{{$key}}" class="client_heading">Quantity: </label>
                                                <input type="number" class="form-control input_div item_quantity" name="qty[]" id="qty_{{$key}}" value="{{$edit_bill_details[$key]->quantity}}">
                                            </div>
                                            <div class="col-sm-3">
                                                <label for="total_{{$key}}" class="client_heading">Total: </label>
                                                <span id="total_{{$key}}" class="span_div"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 mt-2">
                                            ...
                                            <div class="col-sm-6">
                                                <label for="desc_{{$key}}" class="client_heading">Description: </label>
                                                <textarea name="desc[]" id="desc_{{$key}}" class="form-control input_div"></textarea>
                                            </div>
                                        </div>
        ...
        <div class="col-6 text-end" id="">
            ...
            <button class="btn bg-gradient-dark mb-0" type="submit">Update Bill</button>
        </div>
    ...
    $(document).ready(function() {
            ...
            <div class="li">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6 mt-1" id="wt2_details_${counter}" style="display: none;">
                        <div class="select_box">
                            ...
                            <input type="text" class="form-control input_div wt2_details" name="selectwt2[]" id="ip_wt2_${counter}">
								...
								<div id="hsn_gst" class="hsn_gst" style="display: none;">
                                    ...
                                    <div class="row  mb-3 " id="hsn_block_other_${counter}" style="display: none;">
                                        <div class="col-sm-6">
                                            <label for="hsn" class="client_heading">HSN Code: </label>
                                            <input type="text" name="hsn[]" id="hsn_other_${counter}" class="form-control input_div" value="0">
                                        </div>

                                        <div class="col-sm-6">
                                            <label for="gst" class="client_heading">GST: </label>
                                            <input type="number" name="other_gst[]" id="other_gst_${counter}" class="form-control input_div" value="0">
                                        </div>
                                    </div>
								</div>
                ...
                <div class="row ">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="number" name="input_rate[]" id="input_rate_${counter}" class="form-control input_div duplicate_rate_input" value="0">
                     ...
                     <div class="col-sm-3">
                        ...
                        <input type="number" class="form-control input_div item_quantity" name="qty[]" id="qty_${counter}" value="0">
                    </div>

                    <div class="col-sm-3">
                        <label for="total_${counter}" class="client_heading">Total: </label>
                        <span id="total_${counter}" class="span_div">0</span>
        ...
        `;
            ...
            $('.wt1_change').on('change', function() {
                ...
                $("#hsn_show_gst_" + newId).val('');
                $("#hsn_gst_" + newId).val('');

                $("#gst_show_block_gst_" + newId).val('');
                $("#gst_block_gst_" + newId).val('');
                ...
                if (workType1Id) {
                    $.ajax({
                        ...
                        success: function(data) {
                            if (document.getElementById('gst_bill').checked) {
                                $('.hsn_gst').show();
                            } else {
                                $('.hsn_gst').hide();
                            }
                            ...
                            if (data == '') {
                                ...
                                document.getElementById('wt2_' + newId).removeAttribute('name');
                                document.getElementById('ip_wt2_' + newId).setAttribute('name', 'selectwt2[]');


                                document.getElementById('hsn_gst_' + newId).removeAttribute('name');
                                document.getElementById('gst_block_gst_' + newId).removeAttribute('name');

                                document.getElementById('hsn_other_' + newId).setAttribute('name', 'hsn[]');
                                document.getElementById('other_gst_' + newId).setAttribute('name', 'gst[]');
                                ...
                                document.getElementById('ip_wt2_' + newId).removeAttribute('name');
                                document.getElementById('wt2_' + newId).setAttribute('name', 'selectwt2[]');


                                document.getElementById('hsn_other_' + newId).removeAttribute('name');
                                document.getElementById('other_gst_' + newId).removeAttribute('name');

                                document.getElementById('hsn_gst_' + newId).setAttribute('name', 'hsn[]');
                                document.getElementById('gst_block_gst_' + newId).setAttribute('name', 'gst[]');
...
<script>
    ...
    $(document).ready(function() {
        ...
        if (bill_data[0].bill_type == 'gst') {
            ...
            $("#non_gst_bill_invoice").val(bill_data[0].invoice_no);
        }

        $('#total_0').text(parseInt(bill_data[0].quantity) * parseInt(bill_data[0].rate));


        $('#desc_0').text(bill_data[0].description);
        ...
        if (workType1Id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    // console.log(bill_data[0].bill_work_type2);

                    if (data == '') {

                        document.getElementById('wt2_0').removeAttribute('name');
                        document.getElementById('ip_wt2_0').setAttribute('name', 'selectwt2[]');


                        // document.getElementById("wt2_0").removeAttribute("id");

                        // $('#wt2_0').val(bill_data[0].bill_work_type2);
                        document.getElementById('hsn_gst_0').removeAttribute('name');
                        document.getElementById('gst_block_gst_0').removeAttribute('name');

                        $('.inputwt2_0').val(bill_data[0].bill_work_type2);

                        $('#wt2_details_0').show();
                        $('#wt2_select_0').hide();
                        $('#hsn_block_other_0').show();
                        $('#hsn_block_gst_0').hide();

                        $('#hsn_other_0').val(bill_data[0].hsn_code);

                        $('#other_gst_0').val(bill_data[0].gst_rate);

                    } else {

                        document.getElementById('ip_wt2_0').removeAttribute('name');
                        document.getElementById('wt2_0').setAttribute('name', 'selectwt2[]');

                        // console.log(wt2Dropdown);
                        document.getElementById('hsn_other_0').removeAttribute('name');
                        document.getElementById('other_gst_0').removeAttribute('name');


                        $('#wt2_details_0').hide();
                        $('#wt2_select_0').show();
                        $('#hsn_block_other_0').hide();
                        $('#hsn_block_gst_0').show();

                        $('#hsn_show_gst_0').val(bill_data[0].hsn_code);

                        $('#hsn_gst_0').val(bill_data[0].hsn_code);

                        $('#gst_show_block_gst_0').val(bill_data[0].gst_rate);

                        $('#gst_block_gst_0').val(bill_data[0].gst_rate);


                        // console.log(bill_data[key + 1]);

                        $(wt2Dropdown).html('<option value="">Select Work Type 2</option>');
                        $.each(data, function(data_key, data_value) {
                            // console.log(data_value);
                            let selected = (data_value.id == bill_data[0].wt2_id) ? 'selected' : '';
        ...
        $.each(bill_data, function(key, value) {
            ...
            if (bill_data[key].bill_type == 'gst') {
                $('.hsn_gst').show();
            }

            $('#total_' + (parseInt(key) + 1)).text(parseInt(bill_data[key + 1].quantity) * parseInt(bill_data[key + 1].rate));

            $('#desc_' + (parseInt(key) + 1)).text(bill_data[key + 1].description);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data == '') {
                            ...
                            document.getElementById('wt2_' + (parseInt(key) + 1)).removeAttribute('name');
                            document.getElementById('ip_wt2_' + (parseInt(key) + 1)).setAttribute('name', 'selectwt2[]');


                            // document.getElementById("wt2_" + (parseInt(key) + 1)).removeAttribute("id");
                            // $('#wt2_' + (parseInt(key) + 1)).val(bill_data[key+1].bill_work_type2);
                            $('.inputwt2_' + (parseInt(key) + 1)).val(bill_data[key + 1].bill_work_type2);

                            document.getElementById('hsn_gst_' + (parseInt(key) + 1)).removeAttribute('name');
                            document.getElementById('gst_block_gst_' + (parseInt(key) + 1)).removeAttribute('name');
                            ...
                            $('#hsn_other_' + (parseInt(key) + 1)).val(bill_data[key + 1].hsn_code);

                            $('#other_gst_' + (parseInt(key) + 1)).val(bill_data[key + 1].gst_rate);

                        } else {
                            document.getElementById('ip_wt2_' + (parseInt(key) + 1)).removeAttribute('name');
                            document.getElementById('wt2_' + (parseInt(key) + 1)).setAttribute('name', 'selectwt2[]');
                            // console.log(wt2Dropdown);
                            ...
                            document.getElementById('hsn_other_' + (parseInt(key) + 1)).removeAttribute('name');
                            document.getElementById('other_gst_' + (parseInt(key) + 1)).removeAttribute('name');


                            $('#hsn_show_gst_' + (parseInt(key) + 1)).val(bill_data[key + 1].hsn_code);

                            $('#hsn_gst_' + (parseInt(key) + 1)).val(bill_data[key + 1].hsn_code);

                            $('#gst_show_block_gst_' + (parseInt(key) + 1)).val(bill_data[key + 1].gst_rate);

                            $('#gst_block_gst_' + (parseInt(key) + 1)).val(bill_data[key + 1].gst_rate);
                            ...
                            $.each(data, function(data_key, data_value) {
                                // console.log(data_value);
                                let selected = (data_value.id == bill_data[key + 1].wt2_id) ? 'selected' : '';
                                $(wt2Dropdown).append('<option value="' + data_value.id + '" ' + selected + ' >' + data_value.wt_2_item + '</option>');
                            });
                        }
                    }
    ...
    $('.wt1_change').on('change', function() {
        ...
        var wt2Dropdown = $("#" + selectId.replace("wt1", "wt2"));
        $("#hsn_show_gst_" + extractedValue).val('');
        $("#hsn_gst_" + extractedValue).val('');

        $("#gst_show_block_gst_" + extractedValue).val('');
        $("#gst_block_gst_" + extractedValue).val('');
        // console.log($("#select_wt2_0"));
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data == '') {
                        ...
                        document.getElementById('wt2_' + extractedValue).removeAttribute('name');
                        document.getElementById('ip_wt2_' + extractedValue).setAttribute('name', 'selectwt2[]');


                        document.getElementById('hsn_gst_' + extractedValue).removeAttribute('name');
                        document.getElementById('gst_block_gst_' + extractedValue).removeAttribute('name');

                        document.getElementById('hsn_other_' + extractedValue).setAttribute('name', 'hsn[]');
                        document.getElementById('other_gst_' + extractedValue).setAttribute('name', 'gst[]');
                        ...
                        document.getElementById('ip_wt2_' + extractedValue).removeAttribute('name');
                        document.getElementById('wt2_' + extractedValue).setAttribute('name', 'selectwt2[]');


                        document.getElementById('hsn_other_' + extractedValue).removeAttribute('name');
                        document.getElementById('other_gst_' + extractedValue).removeAttribute('name');

                        document.getElementById('hsn_gst_' + extractedValue).setAttribute('name', 'hsn[]');
                        document.getElementById('gst_block_gst_' + extractedValue).setAttribute('name', 'gst[]');
...
<script>
    ...
    document.getElementById('gst_bill').addEventListener('change', function() {
        if (this.checked) {
            ...
            $("#gst_block").hide();
            $("#non_gst_bill_invoice").show();
            document.getElementById("non_gst_bill_invoice_show").disabled = false;
...
<script>
    $(document).ready(function() {
        $("#asas").submit(function(e) {
            let isValid = true;
            let errorMessage = "";

            // Clear previous highlights
            $(".input_div, .form-select").removeClass("is-invalid");
            ...
            // Order No
            const orderNo = $('#order_no').val().trim();
            if (!orderNo) {
            ...
            if (!document.getElementById('gst_bill').checked) {
                const invoiceHidden = $("#non_gst_bill_invoice_show").val().trim();
                if (!invoiceHidden) {
                    $('#non_gst_bill_invoice_show').addClass('is-invalid');
                    isValid = false;
                }
            ...
            if (existing_client == '') {
                if (new_client_name == "" || new_ph_no == "" || new_address == "") {
                    $(this).find("#client_name").addClass("is-invalid");
                    $(this).find("#ph_no").addClass("is-invalid");
                    $(this).find("#address").addClass("is-invalid");
                    $(this).find(".select2-selection__rendered").addClass("is-invalid");
            ...
            $(".li").each(function(index) {
                ...
                const selectwt2 = $(this).find("[name='selectwt2[]']").val();
                if (!selectwt2) {
                    // $(this).find("[name='selectwt2[]']").addClass("is-invalid");
                    $(this).find(".select2-selection__rendered").addClass("is-invalid");
                    isValid = false;
                }
                ...
                // Validate Rate
                const rate = $(this).find("[name='input_rate[]']").val();
                if (!rate || rate <= 0) {
                    $(this).find("[name='input_rate[]']").addClass("is-invalid");
                    isValid = false;
                }

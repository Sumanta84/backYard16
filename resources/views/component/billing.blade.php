                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-lg-4 mb-4">
                                <div class="card">
                                            ...
                                            <div class="col-sm-6 mb-md-0 mb-6">
                                                <div class="   align-items-left ">
                                                    ...
                                                    <select class="form-select select_list select2" id="selectclient" name="selectclient">
                                                        ...
                                                        <option value="{{$client_data->id}}">{{$client_data->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body p-3" id="new_client">
                                        ...
                                        <!-- <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="project" class="client_heading">Address*: </label>
                                            <textarea name="address" id="address" class="form-control input_div"></textarea>
                                        </div>
                                    </div> -->
                                    </div>
                            ...
                            <div class="col-md-12 mb-md-4">
                                <div class="card card-body border  border-radius-lg d-flex align-items-left order_details">
                                    <div class="row ">
                                        <div class="col-md-12 mb-3">
                                            <div class="card-header pb-0 px-3">
                                        ...
                                        <div class="col-md-3 mt-2" id="non_gst_bill_invoice">
                                            ...
                                            <label for="non_gst_bill_invoice_no" class="client_heading">Invoice no</label>



                                            <input type="text" name="non_gst_bill_invoice" id="non_gst_bill_invoice_no" placeholder="Invoice no"
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <ul class="list-group" id="workTypeList">
                                    ...
                                    <div class="li">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="select_box">
                                                    ...
                                                    <select class="form-select select_list wt1_change select2" id="wt1_1" name="selectwt1[]">
                                            ...
                                            <div class="col-sm-6" id="wt2_select_1">
                                                <div class="select_box">
                                                    <label for="wt2_1" class="client_heading">Work type 2: </label>
                                                    <select class="form-select select_list wt2_change select2 wt2_select_box select_wt2_1 is-invalid" id="wt2_1" name="selectwt2[]" onchange="">
                                            ...
                                            <div class="col-sm-6 mt-1" id="wt2_details_1" style="display: none;">
                                                <div class="select_box">
                                                    ...
                                                    <input type="text" class="form-control input_div wt2_details wt2_input_box input_wt2_1 select2-selection__rendered" name="selectwt2[]" id="ip_wt2_1">
                                        ...
                                        <div id="hsn_gst" class="hsn_gst" style="display: none;">
                                            ...
                                            <div class="row  mb-3" id="hsn_block_gst_1" style="display: none;">
                                                <div class="col-sm-6">
                                                    <label for="hsn" class="client_heading">HSN Code: </label>

                                                    <input type="text" id="hsn_show_gst_1" class="form-control input_div" value="" disabled>

                                                    <input type="hidden" name="hsn[]" id="hsn_gst_1" class="form-control input_div" value="">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="gst" class="client_heading">GST: </label>

                                                    <input type="number" id="gst_show_block_gst_1" class="form-control input_div" value="" disabled>


                                                    <input type="hidden" name="gst[]" id="gst_block_gst_1" class="form-control input_div" value="">
                                                </div>
                                            </div>


                                            <div class="row  mb-3 " id="hsn_block_other_1" style="display: none;">
                                                <div class="col-sm-6">
                                                    <label for="hsn" class="client_heading">HSN Code: </label>
                                                    <input type="text" name="hsn[]" id="hsn_other_1" class="form-control input_div" value="0">
                                                </div>

                                                <div class="col-sm-6">
                                                    <label for="gst" class="client_heading">GST: </label>
                                                    <input type="number" name="other_gst[]" id="other_gst_1" class="form-control input_div" value="0">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- hsn code and gst block -->
                                        <div class="row ">
                                            <div class="col-sm-3">
                                                <label for="unit_1" class="client_heading">Unit: </label>
                                                <!-- <span id="unit_1" class="span_div"></span> -->
                                            ...
                                            <div class="col-sm-3">
                                                <label for="rate_1" class="client_heading">Rate: </label>
                                                <input type="number" name="input_rate[]" id="input_rate_1" class="form-control input_div duplicate_rate_input" value="0">
                                                <!-- <span id="rate_1" class="span_div duplicate_rate_span"></span> -->

                                                <!-- <input type="number" name="input_duplicate_rate[]" id="input_duplicate_rate_1" class="form-control input_div d-none duplicate_rate_input"> -->
                                            </div>
                                            <div class="col-sm-3">
                                                <label for="quantity_1" class="client_heading">Quantity: </label>
                                                <input type="number" class="form-control input_div item_quantity" name="qty[]" id="qty_1" value="0">
                                            </div>
                                            <div class="col-sm-3">
                                                <label for="total_1" class="client_heading">Total: </label>
                                                <span id="total_1" class="span_div">0</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 mt-2">
                                            ...
                                            <div class="col-sm-6">
                                                <label for="desc_1" class="client_heading">Description: </label>
                                                <textarea name="desc[]" id="desc_1" class="form-control input_div"></textarea>
                                            </div>
                                        </div>
                            ...
                            @endif
                            <!-- <h6 class="text-center text-danger" id="error_msg">Required Fields are not correctly fillup</h6> -->
                        </div>
                    </div>
                </div>
                            ...
                            <tbody id="bill_body">
                                ...
                                <!-- <tr>
                                    <td colspan="5" class="text-end">
                                        <p>SGST: X% <br> CGST: Y% <br> IGST: Z%</p>
                                    </td>
                                    <td class="fw-bold">12,125+GST</td>
                                </tr> -->
                            </tbody>
                        </table>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-6 mt-1" id="wt2_details_${counter}" style="display: none;">
                        <div class="select_box">
                            ...
                            <input type="text" class="form-control input_div wt2_details" name="selectwt2[] select2-selection__rendered" id="ip_wt2_${counter}">
                ...
                if (workType1Id) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data == '') {
                                // document.getElementsByClassName('select_wt2_1').removeAttribute('name');
                                // document.getElementsByClassName('select_wt2_1').removeAttribute('id');
                                ...
                                // document.getElementsByClassName('input_wt2_1').removeAttribute('name');
                                // document.getElementsByClassName('input_wt2_1').removeAttribute('id');
                ...
                if (workType1Id) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            // if (data.igst_rate == null || data.igst_rate == 0 || data.igst_rate == '') {
                            //     $('#hsn_block_cgst_'+newId).show();
                            //     $('#hsn_block_igst_'+newId).hide();
                            //     $('#cgst_block_sgst_'+newId).val(data.sgst_rate);
                            //     $('#cgst_block_cgst_'+newId).val(data.cgst_rate);

                            //     $('#cgst_show_block_sgst_'+newId).val(data.sgst_rate);
                            //     $('#cgst_show_block_cgst_'+newId).val(data.cgst_rate);

                            //     $('#hsn_cgst_'+newId).val(data.hsn_code);
                            //     $('#hsn_show_cgst_'+newId).val(data.hsn_code);


                            //     $('#hsn_block_other_'+newId).hide();
                            // } else {
                            //     $('#hsn_block_other_'+newId).hide();
                            //     $('#hsn_block_cgst_'+newId).hide();
                            //     $('#hsn_block_igst_'+newId).show();
                            //     $('#igst_block_igst_'+newId).val(data.igst_rate);
                            //     $('#igst_show_block_igst_'+newId).val(data.igst_rate);

                            //     $('#hsn_igst_'+newId).val(data.hsn_code);

                            //     $('#hsn_show_igst_'+newId).val(data.hsn_code);
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data == '') {
                        // document.getElementsByClassName('select_wt2_1').removeAttribute('name');
                        // document.getElementsByClassName('select_wt2_1').removeAttribute('id');
                        // document.getElementsByClassName('input_wt2_1').setAttribute('name', 'selectwt2[]');
                        // document.getElementsByClassName('input_wt2_1').setAttribute('id', 'wt2_1');


                        document.getElementById('wt2_1').removeAttribute('name');
                        // document.getElementById('wt2_1').removeAttribute('id');


                        document.getElementById('ip_wt2_1').setAttribute('name', 'selectwt2[]');
                        // document.getElementById('ip_wt2_1').setAttribute('id', 'wt2_1');

                        // $('.wt2_select_box').val('');
                        $('#wt2_details_1').show();
                        $('#wt2_select_1').hide();
                        $('#hsn_block_other_1').show();
                        $('#hsn_block_gst_1').hide();

                    } else {


                        document.getElementById('ip_wt2_1').removeAttribute('name');


                        document.getElementById('wt2_1').setAttribute('name', 'selectwt2[]');

                        $('#wt2_details_1').hide();
                        $('#wt2_select_1').show();
                        $('#hsn_block_other_1').hide();
                        $('#hsn_block_gst_1').show();
                    ...
                    // // ✅ Reinitialize select2 after options added
                    // $(wt2Dropdown).select2({
                    //     placeholder: "Select Work type 2"
                    // });
                }
        ...
        if (workType1Id) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // $("#unit_" + newId).text(data.unit);
                    // $("#rate_" + newId).text(data.rate);
                    // $("#input_rate_" + newId).val(data.rate);

                    // var q = $("#qty_" + newId).val();

                    // $("#total_" + newId).text(data.rate * q);
    ...
    document.getElementById("preview_btn").addEventListener("click", function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // console.log(data.client_data.name);
    ...
    $(document).ready(function() {
        $("#asas").submit(function(e) {
            ...
            if (!document.getElementById('gst_bill').checked) {
                ...
                // Invoice No (shown input is disabled, but validate hidden one)
                const invoiceHidden = $("#non_gst_bill_invoice_no").val().trim();

                if (!invoiceHidden) {
                    $('#non_gst_bill_invoice_no').addClass('is-invalid');
                    isValid = false;
                }
...
<script>
    ...
    //     console.log(workType1Id, selectId, wt2Dropdown);

    // });

    function clear_field(id) {
        // console.log(id);
        const resultId = id.split("_")[1];
        // const match = str.match(/_(\d+)/);
        // const resultId = match ? match[1] : null;
        // console.log($('#wt2_'+resultId).val());



        $('#wt2_' + resultId).val('');
        document.getElementById("wt2_" + resultId).value = "";
        // console.log('hi');
        document.getElementById("hsn_gst_" + resultId).value = "";

        document.getElementById("gst_block_gst_" + resultId).value = "";

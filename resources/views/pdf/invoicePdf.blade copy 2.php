...
<body>
    ...
    <section class="project_details" style="">
        <div class="content_wrapper">
            ...
            <table>
                <tr>
                    ...
                    <td style="text-align: left; border: none; border-left: 1px solid #000; width: 50%;">
                        ...
                        <br>
                        <span style="padding-bottom: 3px; display: inline-block;"><b>Page No :</b>01</span>
                        <br>
            ...
            <table style="position: relative; max-height: 350px;">
                ...
                <tbody>
                    ...
                    <tr style="height:150px;">
                        <td style="border-left: none; border-top: none; height: 300px;"></td>
                        <td style="border-top: none;"></td>
                        <td style="border-top: none;"></td>
                        <td style="border-top: none;"></td>
                        <td style="border-top: none;"></td>
                    ...
                    <tr>
                        ...
                        <td style="border: none; border-bottom: 1px solid #000;"></td>
                        <td style="text-align: left;border: none;border-right: 1px solid #000; border-bottom: 1px solid #000;"><b></b></td>
                        <td style="text-align: right;border: none;border-right: 1px solid #000; border-bottom: 1px solid #000;">2108.400</td>

                        <td style="text-align: right;border: none;border-right: 1px solid #000;border-bottom: 1px solid #000;"></td>
                        <td style="text-align: right;border: none;border-bottom: 1px solid #000;">65736.00</td>
                    </tr>
                    ...
                    <!-- <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td style="text-align: right; border-right: none;">{{number_format($net_total,2)}}</td>
                    </tr> -->
                </tbody>
            </table>
            @endif

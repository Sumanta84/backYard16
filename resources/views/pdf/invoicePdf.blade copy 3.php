...
<body>
    ...
    <section class="project_details" style="">
        <div class="content_wrapper" style="position: relative;">
            <img src="/home/elp/workdrive/localserver/pdfconverter/public/assets/img/logo/LOGO_SUBMARK2.png" alt="image" style=" height: 200px;
                width: 250px;
                position: absolute;
                display: table;
                margin: auto;
            ...
            <table style="position: relative;font-size: 13px;min-height: 350px">
            ...
            <table style="position: relative; min-height: 350px;">

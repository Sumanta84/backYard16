            ...
            <div class="table_footer" style=" padding-bottom: 30px;">
                <table class="officeuse_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 28%;font-size: 12px; padding:5px 0;">{{$bill->description}}</td>
                            <td style="width: 22%;font-size: 12px; padding:5px 0;">{{$bill->wt_2_item}} <br> <span style="font-size: 13px;">({{$bill->wt_1_item}})</span> </td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="5" rowspan="6" style="font-size: 15px; padding:5px 0;">Total Invoice Amount in words: <br>{{$amountInWords}} only</td>
                            ...
                            <td style="font-size: 12px; padding:5px 0;">{{number_format($gst_data->total_amt)}}</td>
                            @endif
                        </tr>
                        @if($bill_data[0]->bill_type == 'gst')
                        @if(!$gst_data->igst_percentage)
                        <tr>
                            <td style="text-align: left;font-size: 12px; padding:5px 0; ">Add: CGST @ {{$gst_data->cgst_percentage}}%</td>
                            <td style="font-size: 12px; padding:5px 0;">{{number_format($gst_data->cgst_amt)}}</td>
                        </tr>
                        <tr>
                            <td style="text-align: left;font-size: 12px; padding:5px 0;">Add: SGST @ {{$gst_data->sgst_percentage}}%</td>
                            <td style="font-size: 12px; padding:5px 0;">{{number_format($gst_data->sgst_amt)}}</td>
                        </tr>
                        @else
                        <tr>
                            <td style="text-align: left;font-size: 12px; padding:5px 0;">Add: IGST <br>@ {{$gst_data->igst_percentage}}%</td>
                            <td style="font-size: 12px; padding:5px 0;">{{number_format($gst_data->igst_amt)}}</td>
                        </tr>
                        @endif
                        ...
                        <tr>
                            ...
                            <td style="font-size: 12px; padding:5px 0;">{{number_format($gst_data->net_total)}}</td>
                        </tr>
                    </tfoot>
                ...
                <table>
                    <tr>
                        ...
                        <td rowspan="4" style="font-size: 15px; padding:5px 0;"> Authorised Signature </td>
                    </tr>
                    <tr>
